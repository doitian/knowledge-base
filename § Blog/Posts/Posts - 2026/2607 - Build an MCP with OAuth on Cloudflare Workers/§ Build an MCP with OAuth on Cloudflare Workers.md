...
The full example: [doitian/google-task-ifttt-webhook-mcp](https://github.com/doitian/google-task-ifttt-webhook-mcp). Most of it was scaffolded by AI; the interesting part is the structure, not the TypeScript.
